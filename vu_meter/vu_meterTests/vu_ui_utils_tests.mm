...
- (void)test_meter_angle {
    XCTAssertEqualWithAccuracy(vu::ui_utils::meter_angle(audio::math::linear_from_decibel(-20.0f), 0.0f).degrees, 45.0f,
                               0.001f);
    XCTAssertEqualWithAccuracy(vu::ui_utils::meter_angle(audio::math::linear_from_decibel(3.0f), 0.0f).degrees, -45.0f,
                               0.001f);
