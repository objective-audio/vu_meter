...
struct ui_main final {
   ...
   private:
    std::shared_ptr<ui_main_indicator_container_interface> const _indicator_container;
    std::shared_ptr<ui_main_presenter> const _presenter;

    observing::canceller_pool _pool;

    ui_main(std::shared_ptr<ui::view_look> const &, std::shared_ptr<ui_main_indicator_container_interface> const &,
