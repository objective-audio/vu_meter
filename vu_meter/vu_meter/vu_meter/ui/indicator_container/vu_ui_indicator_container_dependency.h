...
struct ui_indicator_for_container {
    ...
    [[nodiscard]] virtual std::shared_ptr<ui::node> const &node() = 0;
...
struct ui_indicator_factory_for_container {
    ...
    [[nodiscard]] virtual std::shared_ptr<ui_indicator_for_container> make_indicator(std::size_t const idx) = 0;
};
}  // namespace yas::vu
