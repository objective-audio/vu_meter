...
namespace yas::vu {
struct ui_indicator_container final : ui_main_indicator_container_interface {
   ...
   private:
    ...
    std::vector<std::shared_ptr<ui_indicator_container_indicator_interface>> _indicators;
    std::shared_ptr<ui_indicator_factory> const _factory;
    std::shared_ptr<ui_indicator_container_indicator_resource_interface> const _resource;
    ...
    ui_indicator_container(std::shared_ptr<vu_ui_indicator_container_presenter> const &,
                           ...
                           std::shared_ptr<ui_indicator_container_indicator_resource_interface> const &);
