...
namespace yas::vu {
struct ui_indicator final : ui_indicator_interface {
    std::shared_ptr<ui::node> const &node() override;

    void set_region(ui::region const) override;

    static std::shared_ptr<ui_indicator> make_shared(
        std::shared_ptr<ui_observable_indicator_resource_interface> const &, std::size_t const);
   ...
   private:
    ...
    ui_indicator(std::shared_ptr<ui::standard> const &,
                 std::shared_ptr<ui_observable_indicator_resource_interface> const &,
